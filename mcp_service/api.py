...
@app.post(
    ...
    summary="Execute Allowlisted Query",
    description=(
        "Executes a safe, allowlisted query by `query_id`. "
        "Payload parameters are query-specific; inspect `GET /v1/queries` or use the "
...
def execute_query(
    payload: QueryRequest = Body(
        ...
        openapi_examples={
            "lead_time_extract": {
                "summary": "Lead Time History",
                "description": "Fetch historical lead-time rows for forecasting input.",
                "value": {
            ...
            "sales_history": {
                "summary": "Sales Monthly History",
                "description": "Fetch monthly sales history by part or aggregate.",
                "value": {
            ...
            "precomputed_forecast": {
                "summary": "Precomputed Forecast Values",
                "description": "Read forecast rows generated by scheduler.",
                "value": {
